...
import { Loader, Monitor, RotateCcw, Smartphone, Tablet } from "lucide-react";
        ...
        <TabsContent value="preview" className="relative rounded-md" key={key}>
          <ComponentWrapper>
            <Button
              ...
              className="absolute right-1.5 top-1.5 z-50 ml-4 flex items-center rounded-lg px-3 py-1"
              variant="ghost"
            >
              ...
              <div
                className={cn(
                  ...
                  viewportSize !== "desktop" &&
                    "border-x border-dashed border-muted-foreground",
                )}
              >
                <React.Suspense
                  fallback={
